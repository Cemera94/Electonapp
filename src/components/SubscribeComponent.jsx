...
function SubscribeComponent() {
    return (
        <div className="flex flex-col lg:flex-row justify-center items-center text-center gap-[20px] bg-[#fff] py-[40px] rounded-[20px] px-[5px]">
            <h3 className="text-mainBlue lg:text-[30px] text-[20px] font-bold">Subscribe newsletter</h3>
            <div className="flex flex-col lg:flex-row items-center lg:justify-between bg-mainOrange text-white rounded-[10px] lg:py-[15px] lg:px-[20px] lg:w-[300px] py-[10px] px-[16px] w-full">
